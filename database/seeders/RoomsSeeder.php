...
class RoomsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('rooms')->insert([
            ...
            ['room_number' => '105A', 'id_roomtype' => 1, 'status' => 'Booked'],
            ['room_number' => '106A', 'id_roomtype' => 1, 'status' => 'Ready'],
            ['room_number' => '107A', 'id_roomtype' => 1, 'status' => 'Booked'],
            ['room_number' => '108A', 'id_roomtype' => 1, 'status' => 'Ready'],
            ['room_number' => '109A', 'id_roomtype' => 1, 'status' => 'Booked'],
            ['room_number' => '110A', 'id_roomtype' => 1, 'status' => 'Booked'],
            ['room_number' => '201B', 'id_roomtype' => 2, 'status' => 'Booked'],
            ...
            ['room_number' => '205B', 'id_roomtype' => 2, 'status' => 'Booked'],
            ...
            ['room_number' => '209B', 'id_roomtype' => 2, 'status' => 'Booked'],
            ['room_number' => '210B', 'id_roomtype' => 2, 'status' => 'Booked'],
            ['room_number' => '301C', 'id_roomtype' => 3, 'status' => 'Booked'],
            ['room_number' => '302C', 'id_roomtype' => 3, 'status' => 'Booked'],
            ['room_number' => '303C', 'id_roomtype' => 3, 'status' => 'Booked'],
            ['room_number' => '304C', 'id_roomtype' => 3, 'status' => 'Booked'],
            ['room_number' => '305C', 'id_roomtype' => 3, 'status' => 'Booked'],
            ['room_number' => '306C', 'id_roomtype' => 3, 'status' => 'Booked'],
            ['room_number' => '307C', 'id_roomtype' => 3, 'status' => 'Booked'],
            ...
            ['room_number' => '404D', 'id_roomtype' => 4, 'status' => 'Booked'],
            ['room_number' => '405D', 'id_roomtype' => 4, 'status' => 'Ready'],
            ['room_number' => '406D', 'id_roomtype' => 4, 'status' => 'Ready'],
            ['room_number' => '407D', 'id_roomtype' => 4, 'status' => 'Booked'],
            ['room_number' => '408D', 'id_roomtype' => 4, 'status' => 'Booked'],
            ['room_number' => '409D', 'id_roomtype' => 4, 'status' => 'Booked'],
